...
then
    ...
    MacBook[23],1|Macmini2,1|MacPro[12],1|MacBookAir1,1|MacBookPro[23],?|Xserve1,?)
        ...
        ;;
    MacBookPro6,?)
        echo "Note: Before 11.2 you need OpenCore and the khronokernel DSDT patch to boot this machines!" $MODEL
    ...
    MacBookPro8,?)
        ...
        ;;
    iMac11,?)
        echo "Detected a Late 2009 or Mid 2010 11,x iMac. Using --2011 patch mode + metal GPU add ons." $MODEL
        echo "Note: Before 11.2 you need OpenCore and the khronokernel DSDT patch to boot this machines!"
        PATCHMODE=--2011
        ...
        ;;
    iMac12,?)
        echo "Detected a Mid 2011 12,x iMac. Using --2011 patch mode + metal GPU add ons." $MODEL
        PATCHMODE=--2011
        INSTALL_IMACMETAL="YES"
        INSTALL_MCCS="YES"
        INSTALL_APPLEGVA="NO"
    ...
    Macmini6,?|MacBookAir5,?|MacBookPro9,?|MacBookPro10,?|iMac13,?)
        ...
        ;;
    MacPro3,[1-3])
        echo "Detected a 2008-2009 Mac Pro. Using --2010 patch mode + HDMI_AUDIO patch." $MODEL
        PATCHMODE=--2010
        INSTALL_HDMI_AUDIO="YES"
        ;;
    MacPro[45],1)
        echo "Detected a 2009-2012 Mac Pro. Using --2012 patch mode + HDMI_AUDIO patch." $MODEL
        PATCHMODE=--2012
        INSTALL_HDMI_AUDIO="YES"
